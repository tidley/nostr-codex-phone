...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 919982125;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        10 => wire__crate__api__nostr__fips_call_send_realtime_audio_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        11 => wire__crate__api__nostr__fips_call_send_realtime_pcm_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        12 => wire__crate__api__nostr__fips_call_stop_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__nostr__nostr_fetch_recent_messages_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        17 => wire__crate__api__nostr__nostr_is_started_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__nostr__nostr_next_message_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__nostr__nostr_send_audio_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__nostr__nostr_send_ephemeral_query_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__nostr__nostr_send_error_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__nostr__nostr_send_query_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__nostr__nostr_send_response_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__nostr__nostr_start_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__nostr__nostr_stop_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        14 => wire__crate__api__nostr__nostr_default_relays_impl(ptr, rust_vec_len, data_len),
        16 => wire__crate__api__nostr__nostr_generate_secret_key_impl(ptr, rust_vec_len, data_len),
        19 => wire__crate__api__nostr__nostr_public_key_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
