...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1116164920;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__nostr__nostr_fetch_recent_messages_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        6 => wire__crate__api__nostr__nostr_is_started_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__nostr__nostr_next_message_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__nostr__nostr_send_audio_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__nostr__nostr_send_error_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__nostr__nostr_send_query_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__nostr__nostr_send_response_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__nostr__nostr_start_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__nostr__nostr_stop_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    match func_id {
        ...
        5 => wire__crate__api__nostr__nostr_generate_secret_key_impl(ptr, rust_vec_len, data_len),
        8 => wire__crate__api__nostr__nostr_public_key_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
